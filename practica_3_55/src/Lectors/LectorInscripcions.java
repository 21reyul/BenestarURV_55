...
public class LectorInscripcions {
    ...
    public static void llegirFitxer(
        ...
        File fitxer = new File("C:\\Practica3\\practica_3_55\\src\\Inscripcions.txt\\");
        ...
        try (Scanner sc = new Scanner(fitxer)) {
            ...
            while (sc.hasNextLine()) {
                ...
                if (usu == null) {
                    Usuari u = buscarUsuari(llistaUsu, aliesUsu);
                    if (u == null) {
                        System.err.println("Línia " + liniaNum + ": usuari no trobat: " + aliesUsu);
                        continue;
                    }
                }
