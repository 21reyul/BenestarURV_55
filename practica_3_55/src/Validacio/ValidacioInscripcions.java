...
public class ValidacioInscripcions {
        ...
        System.out.println("Informacio inscripcio 2 inicial =>\n Places = " + inscripcio2.getNumPlaçes() + 
                         ...
                         "\n MAX = " + inscripcio2.getMAX() + "\n");

        // setters
        inscripcio1.setNumPlaçes(25);
        inscripcio1.setMAX(50); 
        inscripcio2.setMAX(45);
        
        System.out.println("Informacio inscripcio 1 modificada =>\n Places = " + inscripcio1.getNumPlaçes() + 
                         "\n MAX = " + inscripcio1.getMAX() + "\n");

        // Creació d'usuaris per proves
        Usuaris usuari1 = new Usuaris("anna123", "anna.garcia@email.com");
        Usuaris usuari2 = new Usuaris("marc45", "marc.lopez@email.com");
        Usuaris usuari3 = new Usuaris("julia99", "julia.m@email.com");
        Usuaris usuari4 = new Usuaris("carlos77", "carlos.s@email.com");
        Usuaris usuari5 = new Usuaris("laura22", "laura.f@email.com");
       ...
       // Proves d'inscripció
        ...
        for (int i = 0; i < 18; i++) { // Ja tenim 2, en falta 18 per arribar a 20
            Usuaris usuariExtra = new Usuaris("extra" + i, "extra" + i + "@test.com");
        ...
        Usuaris usuariEspera = new Usuaris("espera1", "espera@test.com");
